                ...
                <div class="col-md-4 col-md-offset-4">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="keperluan" data-userid="<?= $cuti_by_id['user_id'] ?>" data-keperluan="<?= $cuti_by_id['keperluan'] ?>" id="keperluan">
                                <option></option>
...
<script>
    ...
    const edit_keperluan = $("#keperluan").data("keperluan");
    $("#keperluan").change(function() {
        console.log($(this).data("userid"));
        if ($(this).val() == edit_keperluan) {
            $.ajax({
                url: "<?= base_url() ?>cuti/edit_cuti_ajax",
                type: "get",
                dataType: "json",
                data: {
                ...
                success: function(data) {
                    if (data.status == 200) {
                        $("[name='tgl_mulai']").val(data.cuti.tgl_mulai);
                        $("[name='tgl_sampai']").val(data.cuti.tgl_sampai);
                        $("[name='lama']").val(data.cuti.lama);
                        $("[name='keterangan']").val(data.cuti.keterangan);
                    }
                }
            });
            ...
            if ($(this).val() == "Cuti Sakit" || $(this).val() == "Cuti Lain-lain") {
                $("[name='tgl_mulai']").val("");
                $("[name='tgl_sampai']").val("");
                $("[name='lama']").val("");
                $("[name='keterangan']").val("");
    ...
    //         case "Cuti Sakit":
    //         case "Cuti Lain-lain":
    //             // $("[name='tgl_sampai']").removeAttr("readonly");
    //             // $("[name='tgl_mulai']").val("");
    //             // $("[name='tgl_sampai']").val("");
    //             // $("[name='lama']").val("");
